...
INSERT INTO "new_ReceiptDraft" ("createdAt", "hargaPostage", "hargaSeunit", "id", "kuantiti", "namaKolejVokasional", "namaPenerima", "perkara", "semester", "tarikh", "updatedAt") SELECT "createdAt", "hargaPostage", "hargaSeunit", "id", "kuantiti", "namaKolejVokasional", "namaPenerima", "perkara", "semester", "tarikh", "updatedAt" FROM "ReceiptDraft";
