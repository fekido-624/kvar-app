...
CREATE TABLE "new_ReceiptDraft" (
    ...
    "noSeriSebatHarga" TEXT NOT NULL DEFAULT '',
...
INSERT INTO "new_ReceiptDraft" ("createdAt", "hargaPostage", "hargaSeunit", "id", "kuantiti", "namaKolejVokasional", "namaPenerima", "noResit", "perkara", "semester", "tajuk", "tarikh", "updatedAt") SELECT "createdAt", "hargaPostage", "hargaSeunit", "id", "kuantiti", "namaKolejVokasional", "namaPenerima", "noResit", "perkara", "semester", "tajuk", "tarikh", "updatedAt" FROM "ReceiptDraft";
